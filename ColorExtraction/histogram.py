# Stolen from http://tophattaylor.blogspot.dk/2009/05/python-rgb-histogram.html
# RGB Hitogram
...
imagepath = ('../imgs/copenhagen-painting-thumbnail.jpg')  # The image to build the histogram of


histHeight = 120            # Height of the histogram
histWidth = 256             # Width of the histogram
multiplerValue = 1.00       # The multiplier value basically increases
